...
<div class="baris1">
    <input type="button" value="Pendaftaran Anggota Luar Biasa HIMASIFO" onclick="window.location='albhimasifo.php'"/>
</div>
<div class="baris2">
    <input type="button" value="Pendaftaran Panitia Program Kerja HIMASIFO" onclick="window.location='panitiahimasifo.php'"/>
</div>
