...
<html>
<head>
    <title> daftar.in cetak data pendaftar panitia ISCOM </title>
...
$sql = "SELECT * FROM panitia_iscom ORDER BY id_piscom;";
...
<?php
echo "<br><br><br><h1 align=center style='font-weight: bold; font-size: 40px; font-family: arial; color: black;'> Cetak Data Pendaftar Panitia ISCOM </h1> <br><br>
...
?>
<br><br>
<center> Klik <a href="report_panitiaiscom.php" style="color: white;"> Export to Excel </a> 
        untuk report data Pendaftar Panitia ISCOM ke excel </center><br>
