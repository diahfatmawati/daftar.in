...
<html>
<head>
    <title> daftar.in cetak data pendaftar pengurus ISCOM </title>
...
$sql = "SELECT * FROM anggota_iscom ORDER BY id_aiscom;";
...
<?php
echo "<br><br><br><h1 align=center style='font-weight: bold; font-size: 40px; font-family: arial; color: black;'> Cetak Data Pendaftar Pengurus ISCOM </h1> <br><br>
    <table width='50%' cellpadding='2' cellspacing='0' border='1.5' align=center style='background-color:white; font-size:13px;'>
    <tr>
        <th>NO</th>
        <th>Nama Lengkap</th>
        ...
        <th>Alasan Mendaftar ISCOM</th>
    </tr>";

$no = 1;
    while ($hasil = mysqli_fetch_array($query)) {
        echo "<tr>
            <td>$hasil[id_aiscom]</td>   
            ...
            <td>$hasil[div1]</td>
            <td>$hasil[div2]</td>
            <td>$hasil[alasan_div]</td>
            <td>$hasil[alasan_iscom]</td>
            </tr>";
    $no++;
    }
    echo "</table>";
?>
<br><br>
<center> Klik <a href="report_pengurusiscom.php" style="color: white;"> Export to Excel </a> 
        untuk report data Pendaftar Pengurus ISCOM ke excel </center><br>
