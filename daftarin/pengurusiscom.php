...
<html>
<head>
    <title> daftar.in Pendaftaran Pengurus ISCOM </title>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   if (empty($_POST["wa"]))
    ...
    if (empty($_POST["div1"]))
    {
        $error_div1 = "pilih salah satu";
    }
    else
    {
        $div1 = cek_input($_POST["div1"]);
    }

    if (empty($_POST["div2"]))
    {
        $error_div2 = "pilih salah satu";
    }
    else
    {
        $div2 = cek_input($_POST["div2"]);
    }

    if (empty($_POST["alasan_div"]))
    {
        $error_alasan_div = "Pesan tidak boleh kosong";
    }
    else
    {
        $alasan_div = cek_input($_POST["alasan_div"]);
    }

    if (empty($_POST["alasan_iscom"]))
    {
        $error_alasan_iscom = "Pesan tidak boleh kosong";
    }
    else
    {
        $alasan_iscom = cek_input($_POST["alasan_iscom"]);
    }
}
...
?>
<br><br><br>
<label class="main"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Form Pendaftaran Pengurus ISCOM </label>
<br><br>
<div class="row">
        ...
        <div class="card">
            ...
            <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                ...
                <div class="form-group row">
                    ...
                    <label> : </label>
                <div class="col-sm-8">
                    <input type="text" name="nama_panggilan" class="form-control <?php echo($error_nama_panggilan !="" ? "is-invalid" : "");?>" id="nama_panggilan" placeholder="Nama Panggilan" value="<?php echo $nama_panggilan; ?>">
                ...
                <div class="from-group row">
                    <label for="div1" class="col-sm-3 col-form-label"> Divisi 1 </label>
                    <label> : </label>
                    <div class="col-sm-8">
                    <select class="form-control form-control-sm col-sm-8" name="div1">
                        <option name="div1" value="Divisi Web" id="div1" > Divisi Web </option>
                        <option name="div1" value="Divisi Desktop" id="div1" > Divisi Desktop </option>
                        <option name="div1" value="Divisi Event" id="div1" > Divisi Event </option>
                        <option name="div1" value="Divisi Publikasi" id="div1" > Divisi Publikasi </option>
                        <option name="div1" value="Divisi Humas" id="div1" > Divisi Humas </option>
                    </select>
                    </div>
                    <span class="warning"><?php echo $error_div1; ?></span>
                </div>

                <div class="from-group row">
                    <label for="div2" class="col-sm-3 col-form-label"> Divisi 2 </label>
                    <label> : </label>
                    <div class="col-sm-8">
                    <select class="form-control form-control-sm col-sm-8" name="div2">
                        <option name="div2" value="Divisi Web" id="div2" > Divisi Web </option>
                        <option name="div2" value="Divisi Desktop" id="div2" > Divisi Desktop </option>
                        <option name="div2" value="Divisi Event" id="div2" > Divisi Event </option>
                        <option name="div2" value="Divisi Publikasi" id="div2" > Divisi Publikasi </option>
                        <option name="div2" value="Divisi Humas" id="div2" > Divisi Humas </option>
                    </select>
                    </div>
                    <span class="warning"><?php echo $error_div2; ?></span>
                </div>

                <div class="form-group row">
                    <label for="alasan_div" class="col-sm-3 col-form-label"> Alasan </label>
                    <label> : </label>
                <div class="col-sm-8">
                    <textarea type="text" name="alasan_div" class="form-control <?php echo($error_alasan_div !="" ? "is-invalid" : "");?>" id="alasan_div" placeholder="Alasan memilih divisi" value="<?php echo $alasan_div; ?>"></textarea>
                    <span class="warning"><?php echo $error_alasan_div; ?></span>
                </div>
                </div>

                <div class="form-group row">
                    <label for="alasan_iscom" class="col-sm-3 col-form-label"> Alasan </label>
                    <label> : </label>
                <div class="col-sm-8">
                    <textarea type="text" name="alasan_iscom" class="form-control <?php echo($error_alasan_iscom !="" ? "is-invalid" : "");?>" id="alasan_iscom" placeholder="Alasan mendaftar iscom" value="<?php echo $alasan_iscom; ?>"></textarea>
                    <span class="warning"><?php echo $error_alasan_iscom; ?></span>
                </div>
                </div>
...
<br>
<?php
include "proses_pengurusiscom.php";
?>
</body>
</html>