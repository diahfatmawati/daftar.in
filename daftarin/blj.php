...
?>
<br><br><br>
<label class="main"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Form Pendaftaran Delegasi BLJ </label>
<br><br>
<div class="row">
        ...
        <div class="card">
            ...
            <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                ...
                <div class="form-group row">
                    ...
                    <label> : </label>
                <div class="col-sm-8">
                    <textarea type="text" name="alasan" class="form-control <?php echo($error_alasan !="" ? "is-invalid" : "");?>" id="alasan" placeholder="Alasan mendaftar BLJ" value="<?php echo $alasan; ?>"></textarea>
