...
$sheet->setCellValue('C2', 'Cetak Data Pendaftar Panitia Program Kerja HIMASIFO');
...
$query = mysqli_query($koneksi,"select * from panitia_hima");
$i = 5;
$no = 1;
...
$writer->save('Report Pendaftar Panitia Program Kerja HIMASIFO.xlsx');
?>